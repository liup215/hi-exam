		...
		return function(){
			...
			timeout = setTimeout(function(){
				each(Chart.instances,function(instance){
					// If the responsive flag is set in the chart instance com.hidear.exam.config
...
(function(){
	...
	Chart.Type.extend({
		...
		//Config is automatically merged by the com.hidear.exam.core of Chart.js, and is available at this.options
		initialize:  function(data){
